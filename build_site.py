...
def header(root='', active=''):
    ...
    <div class="header__inner container">
      <a href="{root}index.html" class="header__logo" aria-label="Ananth Sarth Seva Foundation — Home">
        <img src="{root}assets/images/logo-original.jpg" alt="Ananth Sarth Seva Foundation" class="header__logo-img" width="160" height="48" loading="eager">
      </a>
  ...
  <div class="mobile-nav" id="mobile-nav" aria-modal="true" role="dialog" aria-label="Navigation">
    ...
    <div class="mobile-nav__panel">
      <div class="mobile-nav__head">
        <a href="{root}index.html" aria-label="Home"><img src="{root}assets/images/logo-original.jpg" alt="Ananth Sarth Seva Foundation" class="mobile-nav__logo-img" width="140" height="42" loading="lazy"></a>
      ...
      <div class="container">
        <div class="footer__grid">
          <div class="footer__brand">
            <img src="{root}assets/images/logo-original.jpg" alt="Ananth Sarth Seva Foundation" class="footer__brand-logo" width="160" height="48" loading="lazy">
